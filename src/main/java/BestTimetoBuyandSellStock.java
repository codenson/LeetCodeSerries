...
public class BestTimetoBuyandSellStock {
    ...
    public static void main(String args[]) {
        ...
        System.out.println(maxProfit(new int[]{3, 5, 0, 0, 3, 1, 4}));
    ...
    public static int maxProfit(int[] prices) {
        ...
        for (int z = 1; z < prices.length; z++) {

            if (prices[z] < start) {
                start = prices[z];
            } else if (prices[z] - start >= profit) {
                profit = prices[z] - start;
            }
        }
        return profit;
    }
...
/**
 *
 * 121. Best Time to Buy and Sell Stock Solved Easy Topics Companies
 *
